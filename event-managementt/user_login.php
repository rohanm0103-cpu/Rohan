<?php
session_start();
require_once __DIR__.'/inc/db.php'; // make sure this connects to your database
$err = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            // Remove role if not in your users table
...
<head>
<meta charset="utf-8">
<title>User Login - EventSphere</title>
...
<body>
    ...
    <div class="main-container">
        <div class="login-container">
            <div class="login-header">
                ...
                <h1>User Login</h1>
                <p class="subtitle">Welcome back to EventSphere! Please sign in to your account</p>
            </div>
            ...
            <form method="post" id="loginForm">
                ...
                <button type="submit" class="btn-clean" id="loginButton">
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            button.innerHTML = '<i class="fas fa-spinner fa-spin loading"></i> Signing In...';
        });
